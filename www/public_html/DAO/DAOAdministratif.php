...
/*
 * Return la liste des administratif $nom, $prenom, $numeroPersonnel
 */
function selectAdministratif () {
    // TODO coder selectAdministratif
}

/*
 * Return true si le numeros personnel est present dans la tableadministratif, false sinon
 */
function isAdministratif($numeropersonnel) {
    // TODO faire isAdministratif
}
